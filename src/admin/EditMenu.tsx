        ...
        <DialogContent>
          ...
          <form onSubmit={submitHandler} className="space-y-4">
            <div>
              ...
              />
                {error && <span className="text-xs text-red-500 font-medium">{error?.name}</span>}
            </div>
            <div>
              ...
              />
              {error && <span className="text-xs text-red-500 font-medium">{error?.description}</span>}
            </div>
            <div>
              ...
              />
              {error && <span className="text-xs text-red-500 font-medium">{error?.price}</span>}
            </div>
            <div>
